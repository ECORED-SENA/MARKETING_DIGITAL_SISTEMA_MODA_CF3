  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .tarjeta.tarjeta--gris.p-4.mt-5
      PasosB.color-acento-contenido
        ...
        .row.justify-content-center.align-items-center(titulo="¿CUÁL ES EL PROPÓSITO DE ESTE MOMENTO DE APRENDIZAJE?")
          .col-md-10.mb-4.mb-md-0
            p El propósito de este momento está relacionado con que una vez finalice este momento tenga la capacidad de monitorear el plan de mercadeo, a partir de la experiencia obtenida en las redes sociales y comunidades virtuales.            

            img.img-t.img-a.mt-5(src='@/assets/ilustraciones/img3.svg', alt='')

        .row.justify-content-center.align-items-center(titulo="¿CÓMO FINALIZAR ESTE COMPONENTE DE FORMACIÓN")
          .col-md-10.mb-4.mb-md-0
            p Para culminarlo debe recorrer la ruta de aprendizaje que se ha creado a partir de contenido temático y las actividades de aprendizaje.            

            img.img-t.img-a.mt-5(src='@/assets/ilustraciones/img4.svg', alt='')

        .row.justify-content-center.align-items-center(titulo="RECUERDE")
          .col-md-10.mb-4.mb-md-0
            p Mantener una disciplina de estudio de acuerdo con los tiempos que tiene para este componente de formación.
            p Participar de los espacios de interacción del programa. Uno de ellos son los foros.
            p Si tienes duda con respecto a su proceso, no dude en escribirle un correo a su instructor.
            
            p ¿Qué esperar para iniciar? Revisar la siguiente página web y su contenido:  
              a.link(href="https://www.rdstation.com/es/redes-sociales/" target="_blank")
